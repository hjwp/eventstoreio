...
# source: ClientAPI/ClientMessageDtos.proto
...
NewEvent = _reflection.GeneratedProtocolMessageType('NewEvent', (_message.Message,), {
  ...
  '__module__' : 'ClientAPI.ClientMessageDtos_pb2'
